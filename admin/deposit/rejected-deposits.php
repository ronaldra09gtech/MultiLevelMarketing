...
<head>
    ...
    <title>Rejected Deposits - <?php echo $web_name; ?></title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Rejected Deposits</li>
                                </ol>
                            </div>
                        </div>
                    </div>
