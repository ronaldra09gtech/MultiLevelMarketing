...
<head>
    ...
    <title>Withdraw Methods - <?php echo $web_name; ?></title>
            ...
            <div class="page-body">
                <div class="container-fluid">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-6">
                                <h3>Create New Withdraw Method</h3>
                            </div>
                            <div class="col-6">
                                <ol class="breadcrumb">
                ...
                <div class="container-fluid">
                    <form data-action="create" class="needs-validation pb-5" novalidate id="create_withdraw_method_form">
                        <div class=" row">
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title"> New Withdraw Method </h4>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div id="withdraw_requirements_card" class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            ...
                                            <input data-validate="alpha" required="" name="requirement_card_heading" type="text" class="form-control" placeholder="Card Heading" autocomplete="off">
                                            <div class="invalid-feedback">Please provide a valid Card Heading</div>
                                        </div>
