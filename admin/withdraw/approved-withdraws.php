...
$base = '../../';
$active_page = "approved-withdraws";
include $base . "db.php";
check_admin_login();
...
<head>
    ...
    <title>Approved Withdraws - <?php echo $web_name; ?></title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Approved Withdraws</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="display" id="data_tbl">
                                    ...
                                    <tbody>
                                        <?php echo _withdraw_tbl("approved"); ?>
                                    </tbody>
                                </table>
                            </div>
                        </div>
