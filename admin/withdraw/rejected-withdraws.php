...
$base = '../../';
$active_page = "rejected-withdraws";
include $base . "db.php";
check_admin_login();
...
<head>
    ...
    <title>Rejected Withdraws - <?php echo $web_name; ?></title>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="display" id="data_tbl">
                                    ...
                                    <tbody>
                                        <?php echo _withdraw_tbl("rejected"); ?>
                                    </tbody>
                                </table>
                            </div>
                        </div>
