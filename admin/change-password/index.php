            ...
            <div class="page-body">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="_change_password_form" class="needs-validation" novalidate="">
                                ...
                                <div class="row form-row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control" id="validationCustom3" name="confirm_password" placeholder="Confirm New Password" required="" autocomplete="off">
                                        <div class="invalid-feedback">
