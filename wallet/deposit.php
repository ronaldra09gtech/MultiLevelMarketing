            ...
            <div class="page-body">
                ...
                <div class="card">
                        <div class="card-header justify-between">
                            <div>
                                <h5>Deposit amount List</h5>
                                <span>List of Deposit Request opend by you</span>
                            </div>
                            <a href="<?php echo $base_url; ?>/wallet/add-ticket" class="btn btn-success">Create Request</a>
                        </div>
                        <div class="card-body">
