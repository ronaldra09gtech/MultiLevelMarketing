      ...
      return {
        move: function (t, e, o, a) {
          var r,
            ...
            d = 180;
          0 !== a && (
            t.classList.add(n + "-dragged"), (t.style.transform = "translateX(" + a + "px)"), a > 0
            ? ((r = (d - a) / d), l > r && e.hide(g(o, {
        ...
        stopMoving: function (t, e) {
          ...
          (t.style.opacity = ""),
          (t.style.transform = ""),
          t.classList.contains(n + "-dragged") && (t.classList.remove(n + "-dragged"), (t.style.transition = "transform 0.4s ease, opacity 0.4s ease"), setTimeout(function () {
            t.style.transition = "";
          }, 400));
        }
      };
  ...
  return ((e.setSetting = function (t, n, o) {
    ...
    return {
      start: function () {
        "undefined" == typeof a.time.REMAINING && (e.classList.remove(n + "-reseted"), null !== r && ((r.style.transition = "width " + a.timeout + "ms " + a.progressBarEasing), (r.style.width = "0%")), (a.time.START = new Date().getTime()), (a.time.END = a.time.START + a.timeout), (a.time.TIMER = setTimeout(function () {
          ...
          e.classList.contains(n + "-closing") || (i.hide(a, e, "timeout"), "function" == typeof o && o.apply(i));
      ...
      resume: function () {
        "undefined" != typeof a.time.REMAINING
          ? (e.classList.remove(n + "-paused"), null !== r && ((r.style.transition = "width " + a.time.REMAINING + "ms " + a.progressBarEasing), (r.style.width = "0%")), (a.time.END = new Date().getTime() + a.time.REMAINING), (a.time.TIMER = setTimeout(function () {
            clearTimeout(a.time.TIMER),
            e.classList.contains(n + "-closing") || (i.hide(a, e, "timeout"), "function" == typeof o && o.apply(i));
          }, a.time.REMAINING)), i.setSetting(s, "time", a.time))
          : this.start();
      },
      reset: function () {
        clearTimeout(a.time.TIMER),
    ...
    (function () {
      ...
      if (null !== t) {
        ...
        0 === e.length && (t.classList.remove("fadeIn"), t.classList.add("fadeOut"), setTimeout(function () {
          t.remove();
        }, 700));
      }
    })(),
    ...
    (function () {
      if ((
        p.toast.classList.add(n), p.toast.classList.add(n + "-opening"), p.toastCapsule.classList.add(n + "-capsule"), p.toastBody.classList.add(n + "-body"), p.toastTexts.classList.add(n + "-texts"), o || window.innerWidth <= d
    ...
    (function () {
      s.image && (
        p.cover.classList.add(n + "-cover"), (p.cover.style.width = s.imageWidth + "px"), h(s.image.replace(/ /g, ""))
    ...
    (function () {
      s.close
        ? ((p.buttonClose = document.createElement("button")), (p.buttonClose.type = "button"), p.buttonClose.classList.add(n + "-close"), p.buttonClose.addEventListener("click", function (t) {
          t.target;
    ...
    (function () {
      s.progressBar && ((p.progressBar = document.createElement("div")), (p.progressBarDiv = document.createElement("div")), p.progressBar.classList.add(n + "-progressbar"), (p.progressBarDiv.style.background = s.progressBarColor), p.progressBar.appendChild(p.progressBarDiv), p.toast.appendChild(p.progressBar)),
    ...
    (function () {
      s.title.length > 0 && ((p.strong = document.createElement("strong")), p.strong.classList.add(n + "-title"), p.strong.appendChild(f(s.title)), p.toastTexts.appendChild(p.strong), s.titleColor && (p.strong.style.color = s.titleColor), s.titleSize && (
        isNaN(s.titleSize)
        ? (p.strong.style.fontSize = s.titleSize)
        : (p.strong.style.fontSize = s.titleSize + "px")), s.titleLineHeight && (
        isNaN(s.titleSize)
        ? (p.strong.style.lineHeight = s.titleLineHeight)
        : (p.strong.style.lineHeight = s.titleLineHeight + "px"))),
      s.message.length > 0 && ((p.p = document.createElement("p")), p.p.classList.add(n + "-message"), p.p.appendChild(f(s.message)), p.toastTexts.appendChild(p.p), s.messageColor && (p.p.style.color = s.messageColor), s.messageSize && (
        isNaN(s.titleSize)
        ? (p.p.style.fontSize = s.messageSize)
        : (p.p.style.fontSize = s.messageSize + "px")), s.messageLineHeight && (
        isNaN(s.titleSize)
        ? (p.p.style.lineHeight = s.messageLineHeight)
        : (p.p.style.lineHeight = s.messageLineHeight + "px"))),
      s.title.length > 0 && s.message.length > 0 && (
        s.rtl
    ...
    (function () {
      s.overlay && (
        ...
        ? ((p.overlay = document.querySelector("." + n + "-overlay")), p.overlay.setAttribute("data-iziToast-ref", p.overlay.getAttribute("data-iziToast-ref") + "," + s.ref), isNaN(s.zindex) || null === s.zindex || (p.overlay.style.zIndex = s.zindex - 1))
        : (p.overlay.classList.add(n + "-overlay"), p.overlay.classList.add("fadeIn"), (p.overlay.style.background = s.overlayColor), p.overlay.setAttribute("data-iziToast-ref", s.ref), isNaN(s.zindex) || null === s.zindex || (p.overlay.style.zIndex = s.zindex - 1), document.querySelector("body").appendChild(p.overlay)),
      s.overlayClose
        ? (p.overlay.removeEventListener("click", {}), p.overlay.addEventListener("click", function (t) {
    ...
    (function () {
      if (s.animateInside) {
        ...
        var e = 150;
        s.buttons.length > 0 && p.buttons && setTimeout(
          function () {
          ...
          ? 150
          : 0),
        s.inputs.length > 0 && p.inputs && ((e = 150), m(p.inputs.childNodes, function (t, n) {
          setTimeout(function () {
            t.classList.add("revealIn");
          }, e),
          (e += 150);
    ...
    s.drag && (
      a
      ? (p.toast.addEventListener("touchstart", function (t) {
        b.startMoving(this, i, s, t);
      }, !1), p.toast.addEventListener("touchend", function (t) {
        b.stopMoving(this, t);
      }, !1))
      : (p.toast.addEventListener("mousedown", function (t) {
        t.preventDefault(),
        b.startMoving(this, i, s, t);
...
function sweet_popup(type, title,btn_text) {
  swal({
    type: type,
    title: title,
...
function sweetalert_redirect(type, title, redirect_url, condition) {
  if (type == "success") {
    iziToast.success({
      message: title
    });
