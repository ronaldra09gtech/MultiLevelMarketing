...
$('.login-swiper').each(function (index) {
    sliderSelector = this;
    options = {
        init: false,
        loop: true,
...
$(document).on("mouseenter", ".product_wrapper .product-colors-list .color-list", function () {
 $this = $(this);
 $id = $this.data('id');
 $product = $('.product_slide_' + $id);

 
 if ($(".active-swiper-container")[0]) {
     var prevSwiper = document.querySelector(".active-swiper-container").swiper;
     prevSwiper.autoplay.stop();
     $(".active-swiper-container").removeClass("active-swiper-container");
 }

 $product.find(".product-swiper").addClass("active-swiper-container");
 var mySwiper = document.querySelector('.active-swiper-container').swiper
...
var ratingSliderSelector = '.rating-swiper-container',
    ratingoptions = {
        init: false,
        loop: false,
        speed: 800,
...
var ratingSwiper = new Swiper(ratingSliderSelector, ratingoptions);
ratingSwiper.init();
