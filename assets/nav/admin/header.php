            ...
            <ul class="nav-menus">
                <li class="profile-nav">
                    <div class="header-profile">
                        <img src="<?php echo user_image($loggedin_admin_id); ?>" alt="<?php echo user_name($loggedin_admin_id); ?>">
                        <div class="media-body">
                            <div><?php echo user_name($loggedin_admin_id); ?></div>
                            <div class="font-12 text-muted "><?php echo $loggedin_admin_id; ?></div>
                        </div>
                    </div>
                </li>
            </ul>
